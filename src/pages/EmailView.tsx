                  ...
                  isDark
                    ? `${
                        selectedEmail?.id === email.id 
                          ? 'bg-gray-800 border-l-4 border-[#4A90E2]' 
                          : ''
                      } hover:bg-gray-800`
                    : `${
                        selectedEmail?.id === email.id 
                          ? 'bg-blue-50 border-l-4 border-[#4A90E2]' 
                          : ''
                      } hover:bg-gray-50`
                }`}
              >
                <input
                  ...
                  className={`mt-1 mr-4 rounded ${
                    isDark 
                      ? 'bg-gray-700 border-gray-600 checked:bg-[#4A90E2]' 
                      : 'bg-white border-gray-300 checked:bg-[#4A90E2]'
                  }`}
                />
